...
public class TestsConvertMatrix : BaseTest
{
    ...
    {
        var testMatrix1x1 = Matrix<double>.Build.Dense(1, 1);
        var testMatrix3x4 = Matrix<double>.Build.Dense(3, 4);
    ...
    {
        var testMatrix3x3 = Matrix<double>.Build.Dense(3, 3);
